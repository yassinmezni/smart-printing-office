...
void SimpleEmp::on_homeButton_instruction_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}
...
void SimpleEmp::on_supprimerButton_clicked()
{
...
void SimpleEmp::on_tableView_2_activated(const QModelIndex &index)
{
...
void SimpleEmp::on_modifierButton_clicked()
{
    Fournisseur f;
